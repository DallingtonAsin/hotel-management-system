...
class SaleFactory extends Factory
{
  ...
  public function definition()
  {
    ...
    $cashierDesignationId = Designation::where('name',  'Cashier')->first()->id;
    $cashierStaffIds = Staff::where('designation_id', $cashierDesignationId)->pluck('id');
    ...
    return [
      ...
      'cashier_id' => $this->faker->randomElement($cashierStaffIds)
    ];
  }
}
