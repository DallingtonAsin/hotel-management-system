...
class ProfileController extends Controller
{
    ...
    {
        $department = Helper::getDepartment(Auth::user()->department_id);
        $designation = Helper::getDesignation(Auth::user()->designation_id);
     
        return view('pages.main.users.profile.index')
        ->with(compact('department', 'designation'));
    ...
    public function updates(Request $request, $id)
    {
        ...
        if ($request->hasfile('image')) {
            ...
            $directory = "uploads/images/" . Helper::getDesignation(Auth::user()->designation_id);
    ...
    public function update(Request $request, $id)
    {
           ...
           try {
            ...
            if ($request->hasfile('image')) {
                ...
                $file_path = $file->storeAs('images/profile', $file_name, 'public');
