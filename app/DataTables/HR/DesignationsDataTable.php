    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            data-id="' . $designation->id . '" data-original-title="Edit" id="edit-designation"
              class="px-3 py-1 border border-success rounded  edit-designation mx-2">
             <span class="fa fa-pen text-success"></span></a>';

                $btn .= '<a href="javascript:void(0);" id="delete-designation" 
            data-toggle="tooltip" data-original-title="Delete"
             data-id="' . $designation->id . '" class="px-3 py-1 border border-danger rounded trash-btn mx-2"">
            <span class="fa fa-trash-alt" ></span></a>';

                $btn .= '<a href="javascript:void(0);" id="view-designation" 
           data-toggle="tooltip" data-original-title="View"
            data-id="' . $designation->id . '" class="px-3 py-1 border border-secondary rounded text-secondary bolded">
