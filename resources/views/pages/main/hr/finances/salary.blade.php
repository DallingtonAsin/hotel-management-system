...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            ...
            <button type="button" class="btn btn-primary btn-sm outline-none rounded-pill ml-auto mb-2" id="addNewPayment">
            ...
            <div class="modal-content">
                ...
                <form name="salaries" id="SalaryForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary rounded-pill addSalaryBtn" name="addSalaryBtn">Save</button>
