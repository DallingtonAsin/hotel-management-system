            ...
            <div class="row nunito-font">
              ...
              <div class="col-lg-2">
                <h6 class="text-dark">
                  ...
                  <span class="badge badge-info totl_departments">
              ...
              <div class="col-lg-2">
                <h6>
                    <a class=" bolded" href="javascript:void(0)"
                     id="addNewDepartment"> Add department</a>
                </h6>
              </div>
    ...
    $('.addSupplierBtn').click(function (e) {
        ...
        $.ajax({
          ...
          success: function (data) {
              ...
              ResetTblInfo(data);
              var tbl = $('#departments-table').DataTable();
              tbl.ajax.reload();
...
function ResetTblInfo(response)
 {
     ...
     $('.totl_departments').html(totl_number);
   ...
   buttons:{
     ...
     return $.ajax({
         ...
         $.alert({
          ...
          $(".totl_departments").text(data.totl_no);
