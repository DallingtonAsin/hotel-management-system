...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <!-- Add Damage Details -->
            <div class="modal fade" id="addDamagesModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-content nunito-font rounded-0">
                        <form name="damagesForm" id="damagesForm">
                            ...
                            <div class="modal-header text-center">
                                ...
                                <button type="button" class="close view-close text-dark" data-bs-dismiss="modal"
                                    aria-label="Close">
        ...
        <!--Modal DeleteDamage -->
        <div class="modal fade" id="deleteDamageModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div class="modal fade nunito-font" id="importDamages" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#createNewDamage').click(function(e) {
                e.preventDefault();
                checkPermission(permissions.add_damages, function(damage) {
                    ClearFormFields();
            ...
            $('body').on('click', '#edit-damage', function(event) {
                ...
                checkPermission(permissions.edit_damages, function(damage) {
                    editDamage(damage_id);
                });
            });

            function editDamage(damage_id) {
            ...
            $('body').on('click', '#view-damage', function(event) {
                let damage_id = $(this).data('id');
                event.preventDefault();
                checkPermission(permissions.view_damages, function(damage) {
                    viewDamagedItem(damage_id);
                });
            });
