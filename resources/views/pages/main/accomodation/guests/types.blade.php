...
@section('content')
    <div class="card">
        ...
        <div class="card-header d-flex align-items-center">
            ...
            <button type="button" class="btn btn-primary btn-sm outline-none rounded-pill ml-auto mb-2" id="addNewGuestType">
            ...
            <div class="modal-content">
                ...
                <form name="guestTypes" id="GuestTypesForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary rounded-pill addGuestTypeBtn"
