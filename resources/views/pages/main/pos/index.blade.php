...
@section('content')
            ...
            <form id="CartForm" class="form">
                ...
                <div class="row nunito-font">
                    ...
                    <div class="form-group col mt-4 pt-1">
                        <label></label>
                        <button type="button" id="addToCartBtn" class="btn btn-sm btn-info pb-2 text-white"
                ...
                <div class="table table-responsive fixedTableHead" id="cart-div">
                    ...
                    <div class="d-flex justify-content-between" id="menu-cart-footer">
                        <div class="float-left">
                            <button type="submit" class="btn btn-primary submit-order-btn" id="printBtn"><i
                                    class="fa fa-plus-circle pr-1"></i>Submit Order</button>
                        </div>
                        <div id="totals" class="float-right">
                            <div class="d-flex">
                                <h5 class="mr-2">Subtotal:</h5> $<strong id="subtotal">0.00</strong>
                            </div>
                            <div class="d-flex">
                                <h5 class="mr-2">Tax (18%):</h5> $<strong class="text-danger" id="tax">0.00</strong>
                            </div>
                            <div class="d-flex">
                                <h5 class="mr-2">Total:</h5>$<strong class="text-success" id="total">0.00</strong>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function AddItemToCart(searchId, item) {
            ...
            (quantity) ?
            quantity = Convert2Num(quantity): quantity = 1;
                ...
                success: function(dataResult) {
                    ...
                    $.each(resultData, function(index, row) {
                        ...
                        bodyData += "<td>" + row.item + "</td><td>" + row.item_code + "</td><td>" +
                            ...
                            date_of_sale +
                            "</td><td><button class='btn btn-info btn-xs text-white btn-edit edit-row' style='margin-left:20px;'>Edit</button>" +
