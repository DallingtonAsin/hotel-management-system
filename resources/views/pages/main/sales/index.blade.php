                            ...
                            <form name="SaleForm" id="SaleForm">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control item-name bg-white text-dark"
                                            value="">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control sprice bg-white text-dark"
                                            value="">
                                    </div>

                                    <div class="form-group">
                                        <span>Total cost</span>
                                        <input type="text" class="form-control tcost bg-white text-dark"
                                            value="">
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <span>Discount</span>
                                            <input type="text" class="form-control discount bg-white text-dark"
                                                value="">
                                        </div>

                                        <div class="col-lg-6">
                                            <span>Sold at</span>
                                            <input type="text" class="form-control amount bg-white text-danger"
                                                value="">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <span>Customer</span>
                                            <input type="text" class="form-control customer bg-white text-dark"
                                                value="">
                                        </div>

                                        <div class="col-lg-6">
                                            <span>Cashier</span>
                                            <input type="text" class="form-control cashier bg-white text-dark"
                                                value="">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date_of_sale"
                                            class="form-control date bg-white text-dark" value="">
                                    </div>
    ...
    @isset($filtered_sales)
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                let title = "List of filtered sales";
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function UpdateSale(sale_id) {
                ...
                let Url = "{{ route('sales.records.update') }}";
                $.ajax({
            ...
            function validateForm() {
                ...
                let errors = [];
                if (date.length < 1) {
                    let dateErr = "Please enter the date when the item was sold";
                    errors.push(dateErr);
                }
                return errors;
            }
            ...
            function GetItemName(id) {
                ...
                let getUrl = '{{ route('getItemName', ':id') }}';
            ...
            function ResetTblInfo(response) {
                let totl_no, totl_sales, netWorth;
