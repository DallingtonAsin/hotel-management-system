...
<div class="form-group">
    <label for="fname" class="col-form-label text-muted text-md-right"><i class="text-danger">*</i>
        {{ __('First Name') }}</label>
        <input id="fname" type="text" class="form-control first_name" 
         name="firstName" value="" placeholder="Enter cashier's first name" autocomplete="off" >
        @error('firstName')
    ...
    <div class="form-group">
        <label for="lastName" class="col-form-label   text-muted text-md-right"><i class="text-danger">*</i>
            ...
            <input id="lastName" type="text"  class="form-control last_name"
            name="lastName" value="{{old('lastName')}}" placeholder="Enter cashier's last name"  autocomplete="off" >
            @error('lastName')
        ...
        <div class="form-group">
            <label for="address"  class="col-form-label  text-muted text-md-right"><i class="text-danger">*</i>
                ...
                <input id="address" type="text" class="form-control address" name="address" value="" placeholder="Enter address" autocomplete="off" >
                @error('address')
            ...
            <div class="row form-group">
                <div class="col-lg-6">
                    <label for="NIN" class="col-form-label text-muted text-md-right"><i class="text-danger">*</i>
                        {{ __('National ID Number') }}</label>

                        <input id="NIN" type="text" class="form-control national_id"  name="NationalIDNo" value="{{old('NationalIDNo')}}" placeholder="Enter NationalID Number" autocomplete="off"  >
                        @error('NationalIDNo')
                    ...
                    <div class="col-lg-6">
                        <label for="email" class="col-form-label text-muted text-md-right">
                            {{ __('Email') }}</label>
                            <input id="email" type="email" class="form-control email"  placeholder="Enter email" name="email" value="{{old('email')}}"  autocomplete="off">
                        </div>
                        @error('email')
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label for="primaryTelNo" class="col-form-label text-muted text-md-right"><i class="text-danger">*</i>
                                ...
                                value="{{old('tel_no')}}" placeholder="Enter primary telephone number" autocomplete="off" >
                                @error('tel_no')
                            ...
                            <div class="col-lg-6">
                                <label for="company" class="col-form-label text-muted text-md-right">
                                    ...
                                    <input id="company" type="text" class="form-control alt_telno"  name="alt_telno" value="{{old('alt_telno')}}" placeholder="Enter alternative telephone number" autocomplete="off" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <button type="submit" class="btn btn-primary text-white AdduserBtn">
                                            {{ __('Submit') }}
                                        </button>
